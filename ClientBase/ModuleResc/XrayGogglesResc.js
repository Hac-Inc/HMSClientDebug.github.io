...
var buildMetadata = {"date":"Mon Mar 26 2018 00:17:16 GMT+0000 (UTC)","commit":"unknown"};
...
(function(jQuery) {
  ...
  jQuery.webxraySettings = {
    ...
    pluginURLs: [],
    hackpubURL: "",
    idwmoURL: "https://id.webmaker.org",
    publishwmoURL: "https://publish-webmaker-org-prod.herokuapp.com"
  };
})(jQuery);
(function(jQuery) {
  "use strict";
...
(function(jQuery) {
  ...
  function isValidFocusTarget(target) {
    if ($(target).hasClass('webxray-base')) {
      return false;
    }
    while(target) {
      if ($(target).hasClass('webxray-msg-dialog')) {
        return false;
      }
